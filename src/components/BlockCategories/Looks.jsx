...
export const Looks = `
  <category name="Looks" colour="#5C81A6" categorystyle="looks_category">
    <block type="hide"></block>
    <block type="show"></block>
    <block type="sayforsecs"></block>
    <block type="say"></block>
    <block type="thinkforsecs"></block>
    <block type="think"></block>
    <block type="changesizeby"></block>
    <block type="setsizeto"></block>
    <block type="goforbacklayers"></block>
    <block type="gotolayersby"></block>
  </category>
`;
...
Blockly.Blocks["sayforsecs"] = {
  init: function () {
    ...
    this.appendValueInput("SECS").appendField("for").setCheck("Number");
...
Blockly.Blocks["gotolayersby"] = {
  init: function () {
    this.appendDummyInput().appendField("Go");
    ...
    this.appendValueInput("NUMLAYERS").setCheck("Number");
...
javascriptGenerator.forBlock["sayforsecs"] = function (block) {
  ...
  const secs = javascriptGenerator.valueToCode(
    block,
    "SECS",
    javascriptGenerator.ORDER_NONE
  );
...
export const changeSizeBy = (size) => {
  ...
  const percheight = parseFloat(
    spriteimg.style.height.substring(0, spriteimg.style.height.length - 1)
  );
  const percwidth = parseFloat(
    spriteimg.style.width.substring(0, spriteimg.style.width.length - 1)
  );
